 ...
 * @Date: 2020-05-14 10:15:37 
 * @Last Modified by: LiangChenkang
 * @Last Modified time: 2020-05-19 13:45:25
 */
...
<template>
  <div class="form-container">
    <el-form ref="form" :rules="rules" :model="formData" label-position="right" label-width="170px">
      ...
      <el-form-item label="扫描点名称：" prop="mc">
        <el-input v-model="formData.mc" placeholder="请输入扫描点名称" size="small"></el-input>
      </el-form-item>
      <el-divider>地址信息</el-divider>
      <el-form-item label="扫描点地址：" prop="smddz">
        <el-input v-model="formData.smddz" placeholder="请输入扫描点地址" size="small"></el-input>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        mc: { required: true, message: '请输入扫描点名称！' },
        smddz: { required: true, message: '请输入扫描点地址！' },
        jd: [
